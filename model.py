from data_prep import import_data_from_n_sample_drives, flipping_augmentation
...
X_train, y_train = import_data_from_n_sample_drives(data_paths, load_cached=False, save_data_to_pickle=False)
# X_train, y_train = flipping_augmentation(X_train, y_train)

def build_Naive_Example(model):
